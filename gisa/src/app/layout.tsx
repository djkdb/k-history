...
export const metadata: Metadata = {
  title: "정보처리기사 마스터",
  description: "필기는 다섯 과목 과락까지, 실기는 손으로 써 보며",
        ...
        */}
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var p=localStorage.getItem("gisa:theme");var a=p==="light"||(p==="system"&&matchMedia("(prefers-color-scheme: light)").matches)?"light":"dark";document.documentElement.setAttribute("data-theme",a);document.documentElement.style.colorScheme=a;}catch(e){}})();`,
          }}
        />
      </head>
