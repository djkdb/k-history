 ...
 */
const KEY_INAPP = "gisa:inapp-hint";
const KEY_INSTALL = "gisa:install-hint";
            ...
            <div className="relative rounded-2xl border border-indigo-500/25 bg-indigo-500/[0.08] p-4">
              ...
              <div className="flex items-start gap-2.5 pr-9">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-[12px] leading-relaxed text-zinc-400">
                    ...
                    지하철처럼 연결이 끊기는 곳에서도 그대로 풀 수 있습니다.
                  </p>
                </div>
              </div>
                ...
                (!steps ? (
                  ...
                  <ol className="mt-3 flex flex-col gap-2 border-t border-white/10 pt-3">
                    <Step n={1}>
                      ...
                      <Share
                        size={13}
                        className="mx-0.5 inline align-[-2px] text-sky-300"
                      />
                    ...
                    <Step n={2}>
                      ...
                      <Plus
                        ...
                        className="mx-0.5 inline align-[-2px] text-sky-300"
                      />
                      <b className="text-zinc-200">홈 화면에 추가</b> 를
                      누릅니다
                    </Step>
                    <Step n={3}>
                      오른쪽 위 <b className="text-zinc-200">추가</b> 를 누르면
                      끝입니다
                    </Step>
                  </ol>
                ))}
              ...
              {how === "ios-other" && (
                <p className="mt-3 border-t border-white/10 pt-3 text-[12px] leading-relaxed text-amber-200">
                  아이폰에서는 <b>사파리</b>로 열어야 홈 화면에 추가할 수
                  있습니다.
                </p>
              )}
            </div>
      ...
      <div className="flex items-start gap-2.5 pr-9">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-[12.5px] leading-relaxed text-zinc-300">
            여기서 푼 기록은 <b className="text-amber-100">이 화면 안에만</b>{" "}
            남습니다. 나중에 {env.ios ? "사파리" : "크롬"}으로 열면 본 개념도,
            모의고사 점수도 보이지 않습니다. 서버에 사본을 두지 않아 되찾을 수도
            없습니다.
          </p>
