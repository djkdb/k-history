...
export const SQL_TASKS: SqlTask[] = [
  /* ───────── SELECT · 조건 · 함수 ───────── */
  {
    ...
    schema: "emp",
    answer: "SELECT ename, sal FROM emp WHERE sal >= 400 ORDER BY sal DESC;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer: "SELECT ename FROM emp WHERE bonus IS NULL;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer: "SELECT ename, sal + IFNULL(bonus, 0) AS total FROM emp;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer: "SELECT ename, job FROM emp WHERE job IN ('부장', '과장');",
    explanation:
  ...
  /* ───────── GROUP BY · 집계 ───────── */
  {
    ...
    schema: "emp",
    answer: "SELECT deptno, COUNT(*) AS cnt FROM emp GROUP BY deptno ORDER BY deptno;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer:
      "SELECT deptno, COUNT(*) AS cnt FROM emp GROUP BY deptno HAVING COUNT(*) >= 4;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer: "SELECT deptno, AVG(bonus) AS avg_bonus FROM emp GROUP BY deptno ORDER BY deptno;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp,dept",
    answer:
      "SELECT d.dname, COUNT(e.empno) AS cnt FROM dept d LEFT JOIN emp e ON d.deptno = e.deptno GROUP BY d.deptno, d.dname ORDER BY d.deptno;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp,dept",
    answer:
      "SELECT ename FROM emp WHERE deptno IN (SELECT deptno FROM dept WHERE loc = '서울') ORDER BY ename;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer:
      "SELECT e.ename, e.sal FROM emp e WHERE e.sal > (SELECT AVG(x.sal) FROM emp x WHERE x.deptno = e.deptno) ORDER BY e.ename;",
    explanation:
  ...
  /* ───────── 집합 연산자 ───────── */
  {
    ...
    schema: "emp",
    answer:
      "SELECT ename FROM emp WHERE sal >= 500 UNION SELECT ename FROM emp WHERE bonus >= 100 ORDER BY ename;",
    explanation:
  ...
  /* ───────── 윈도우 함수 ───────── */
  {
    ...
    schema: "emp",
    answer:
      "SELECT ename, sal, RANK() OVER (ORDER BY sal DESC) AS rnk FROM emp ORDER BY sal DESC, ename;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer:
      "SELECT ename, deptno, sal, RANK() OVER (PARTITION BY deptno ORDER BY sal DESC) AS rnk FROM emp ORDER BY deptno, sal DESC, ename;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer: "SELECT ename, sal FROM emp ORDER BY sal DESC, ename LIMIT 3;",
    explanation:
...
SELECT ename, lvl FROM t ORDER BY lvl, ename;`,
    explanation:
  ...
  /* ───────── DML ───────── */
  {
    ...
    schema: "emp",
    answer:
      "UPDATE emp SET sal = sal * 1.1 WHERE deptno = 30; SELECT ename, sal FROM emp WHERE deptno = 30 ORDER BY ename;",
    explanation:
  ...
  },
  {
    ...
    schema: "emp",
    answer:
      "SELECT ename, CASE WHEN sal >= 500 THEN '상' WHEN sal >= 300 THEN '중' ELSE '하' END AS grade FROM emp ORDER BY ename;",
    explanation:
